...
const { buyFilm, getTransactions, updateStatusTransaction, filmRate, userRate } = require('../controllers/userFilm')
...
router.get('/rate-film/:id', auth, filmRate)
router.patch('/rate-film/:id/:rate', auth, userRate)
